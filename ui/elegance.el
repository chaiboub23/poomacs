...
(setq-default mode-line-format
     '((:eval
       ...
       (format-mode-line (list
         (propertize "e" 'face `(:inherit mode-line-buffer-id)
...
(defun set-modeline-faces ()
  ...
  ;; Mode line at bottom
   ...
   (set-face-attribute 'mode-line nil
                       :height 1.0
                       :overline "#e1e1e1" ;; (face-background 'default)
                       :underline nil
                       :foreground (face-foreground 'default)
                       :background "#e1e1e1" ;;(face-background 'face-subtle)
                       :box `(:line-width 2
                              :color "#e1e1e1" ;;,(face-background 'face-subtle)
                              :style nil))
   ...
   (set-face-attribute 'mode-line-inactive nil
                       ...
                       :background "#e1e1e1" ;;(face-background 'face-popout)
                       :box `(:line-width 2
                              :color "#e1e1e1" ;;,(face-background 'face-popout)
                              :style nil))
...
(defun elegance-dark ()
    ...
    (set-face-attribute 'face-critical nil :foreground "#385f38"
                                           :background "#f8f893")
    (set-face-attribute 'face-popout nil :foreground "#dd1e28")
    (set-face-attribute 'face-strong nil :foreground "#a8a8a8"
                                         :weight 'regular)
    (set-face-attribute 'face-salient nil :foreground "#0062fa"
                                          :weight 'light)
    (set-face-attribute 'face-faded nil :foreground "#6f6f6f"
                                        :weight 'light)
